...
public class invalid extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
            out.println("<h2 style=\"width:70%; margin: auto;\">It seems you tried to request an order without any products. No worries it happens to all of us. Feel free to "
                    + "go back and check out the sweet guitar collection we got. </h2>");
            out.println("</body>");
            out.println("</html>");
        }
    }
